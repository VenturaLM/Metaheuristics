...
def applyGeneticOperator(population, k, cProb, mProb, prices, weights, maxWeight):
	...
	for i in new_population:
		print(i)
	#	Return the new population (not evaluated) --> NOTA: En ocasiones al eliminar y añadir, el numero resultante de la poblacion final es distinto al de la inicial.
...
#		- Mirar si la asignación es correcta.
...
def main():
	...
	maxGenerations = 1 #Number of generations/iterations [100 - 300].
