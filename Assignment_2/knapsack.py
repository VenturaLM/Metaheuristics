...
def applyGeneticOperator(population, k, cProb, mProb):
	...
	#NOTA: EN ALGÚN MOMENTO HABRÁ QUE EVALUAR LA SOLUCIÓN PARA CORREGIR EL PROFIT FINAL, QUIZÁS PONER DENTRO DE CADA IF UNA BANDERA Y HACERLO ÚNICAMENTE AL FINAL.
